      ...
      <Section>
        <Container className="max-w-3xl space-y-8">
          ...
          <Prose>
            ...
            <p>
              Refunds follow the <a href="/refunds">Refund Policy</a> and the Organizer’s stated
              policy. If an Organizer cancels an event, refund handling is described there.
            </p>
            <h2>5. Organizers</h2>
            <p>
              Organizers additionally agree to the{' '}
              <a href="/organizer-agreement">Organizer Agreement</a>, including accurate listings,
              honoring valid tickets, and lawful operation of their events.
            </p>
            ...
            <h2>9. Privacy</h2>
            <p>
              Personal data is handled per the <a href="/privacy">Privacy Policy</a>.
            </p>
            <h2>10. Changes</h2>
            <p>We may update these terms; material changes will be communicated.</p>
            <h2>11. Contact</h2>
            <p>
              See the <a href="/contact">contact page</a> (details are placeholders in this demo).
            </p>
          </Prose>
        </Container>
      </Section>
