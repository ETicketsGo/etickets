...
export function InstallPrompt() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-[calc(3.75rem+env(safe-area-inset-bottom))] z-50 mx-auto flex max-w-md items-center gap-3 rounded-xl border border-border bg-background-surface p-3 shadow-lg lg:bottom-4 print:hidden"
    >
