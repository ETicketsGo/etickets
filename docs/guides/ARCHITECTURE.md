...
(projection of a signed ticket, fail-closed) · Notifications (pluggable transports) · Analytics/
Reports · Admin/Ops/Audit · Observability (metrics, health, Sentry/OTel).
