...
- **Coupons/promotions:** discount codes (percentage or fixed) are supported end to end at
  checkout. _(Organizer coupon-management UI is a planned enhancement; see the RC/known
  limitations — until then coupons can be provisioned by the platform.)_
