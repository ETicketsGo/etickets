...
| 7     | Bulk / recurring / copy scheduling           | **Partially closed** — overlap prevention, configurable turnaround, bulk expand + preview and race-safe creation shipped (see SHOW-SCHEDULING.md). Pause/reopen/cancel/edit and copy-to-screen still missing                                                                                         | In progress                                                                                                                |
